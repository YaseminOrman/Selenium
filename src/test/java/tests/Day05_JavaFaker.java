...
public class Day05_JavaFaker {
    ...
    -BA-->Business Analyst(Write the acceptance criteria(AC))
    -Test Lead
    -Manual Tester
    -Tech Lead(Team Lead)
    -Developer
    ...
    -Documentations for example swagger doc can be used for Api
    ...
    public void javaFakerTest(){
        ...
        //2.Now we have faker object we can generate the fake data
