...
public class Q02Review extends TestBase {
    ...
    public void test(){
        ...
        List<WebElement> builtYears= driver.findElements(By.xpath("(//tbody)[2]//td[4]"));
        //Calculate min year
     ...
     for(int i=0;i<builtYears.size();i++){
        ...
        System.out.println(idxOfMinYear);
      ...
      String formattedHeight=  decimalFormat.format(heightToBuild);
        ...
        Assert.assertEquals("25.45",formattedHeight);
